...
insert into app_profile (id,created_date,active, account_locked, last_logindtm, login, modified_date, pwd_file_name)
values(10001,sysdate(),true,true,sysdate(),'user1',sysdate(),'file.txt');
insert into app_profile (id,created_date,active, account_locked, last_logindtm, login, modified_date, pwd_file_name)
values(10002,sysdate(),true,true,sysdate(),'user2',sysdate(),'file.txt');
insert into app_profile (id,created_date,active, account_locked, last_logindtm, login, modified_date, pwd_file_name)
values(10003,sysdate(),true,true,sysdate(),'user3',sysdate(),'file.txt');
insert into app_profile (id,created_date,active, account_locked, last_logindtm, login, modified_date, pwd_file_name)
values(10004,sysdate(),true,true,sysdate(),'user4',sysdate(),'file.txt');
insert into app_profile (id,created_date,active, account_locked, last_logindtm, login, modified_date, pwd_file_name)
values(10005,sysdate(),true,true,sysdate(),'user5',sysdate(),'file.txt');

insert into user (id,created_date,email,first_name,last_name,modified_date,password,user_salt,app_profile_id)
values (10001,sysdate(),'foo@foo.com','Todd','McDee',sysdate(),'ABCD45','ABCD46',10001); 
insert into user (id,created_date,email,first_name,last_name,modified_date,password,user_salt,app_profile_id)
values (10002,sysdate(),'foo@foo.com','Todd','McDee',sysdate(),'ABCD45','ABCD46',10002); 
insert into user (id,created_date,email,first_name,last_name,modified_date,password,user_salt,app_profile_id)
values (10003,sysdate(),'foo@foo.com','Todd','McDee',sysdate(),'ABCD45','ABCD46',10003); 
insert into user (id,created_date,email,first_name,last_name,modified_date,password,user_salt,app_profile_id)
values (10004,sysdate(),'foo@foo.com','Todd','McDee',sysdate(),'ABCD45','ABCD46',10004); 
insert into user (id,created_date,email,first_name,last_name,modified_date,password,user_salt,app_profile_id)
values (10005,sysdate(),'foo@foo.com','Todd','McDee',sysdate(),'ABCD45','ABCD46',10005); 
